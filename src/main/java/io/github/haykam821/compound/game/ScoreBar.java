...
public final class ScoreBar {
	...
	private static final Text NAME = new TranslatableText("gameType.compound.compound");
	...
	private Text getTitle() {
		...
		return new TranslatableText("text.compound.bar.title", NAME, score).formatted(FORMATTING);
	}
}
